...
create table hero_equips (hero_id bigint not null, equips_id bigint not null);
...
INSERT INTO hero_equip(hero_id,life_inc, attack_inc, intel_inc, physic_def_inc,  magic_def_inc, 
	tech_inc, life_skill, attack_skill, intel_skill, physic_def_skill, magic_def_skill, tech_skill, 
	life_jjc, intel_jjc, attack_jjc,  physic_def_jjc, magic_def_jjc, tech_jjc,critical_prob_inc, critical_damage_inc, critical_prob_dec,  critical_damage_dec) VALUES
...
(15,'LeatherHelm',473, 0, 0, 0, 59, 0, 'Helmet'),
...
INSERT INTO hero_equips(hero_id, equips_id) VALUES
